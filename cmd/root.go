...
func addDatabaseFlags(cmd *cobra.Command) {
	...
	cmd.Flags().StringP("db", "d", "", "Database name")
	cmd.Flags().Int32P("port", "p", 5432, "Database port")
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.pg-snap.yaml)")
